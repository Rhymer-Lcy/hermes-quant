...
T+1, price-limit no-fill, stamp tax (sell-side ~0.05%), ¥5 minimum commission, 100-share lots, slippage.
...
a futures-style model and omits exactly the frictions that dominate ¥5k–¥30k returns.
"""
